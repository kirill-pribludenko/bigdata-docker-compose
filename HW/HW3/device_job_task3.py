...
def python_data_stream_example():
    ...
    # including fired timer and normal data are processed by the
    # same worker and the collected result would be in order which
    # is good for assertion.
    ...
    sink = KafkaSink.builder() \
        ...
        .set_record_serializer(KafkaRecordSerializationSchema.builder()
                               .set_topic('kir-test-processed-t3')
